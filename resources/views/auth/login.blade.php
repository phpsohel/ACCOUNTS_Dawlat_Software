...
<script type="text/javascript" src="<?php echo asset('public/js/front.js') ?>"></script>
  ...
  <body>
    ...
    <div class="page login-page" style="background: url('{{ asset('public/logo/acquainttechnologies.png')}}'); background-size: cover;">
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner text-center">
            <div class="logo">@if($general_setting->site_logo)<img src="{{url('public/logo', $general_setting->site_logo)}}" width="200">&nbsp;&nbsp;@endif</div>
          ...
          <div class="copyrights text-center">
            <p style='color:black;'>{{trans('file.Developed By')}} <span class="external">{{$general_setting->developed_by}}</span></p>
          </div>
        </div>
      </div>
    </div>
