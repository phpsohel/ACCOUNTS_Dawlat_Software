            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('Sales Person')}}</h4>
                    </div>
                    <div class="card-body">

                        <p class="italic"><small class="text-danger">{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        @if(($item->id))
                        {!! Form::open(['route' => ['salesperson.update',$item->id], 'method' => 'put', 'files' => true]) !!}
                        @else
                        {!! Form::open(['route' => 'salesperson.store', 'method' => 'post', 'files' => true]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mt-4">
                                    <a href="{{ route('salesperson.index') }}" class="btn btn-info"><i class="fa fa-undo px-2"></i> {{trans('Back')}}</a> 
