		                        ...
		                        <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order_discount" value="{{ old('order_discount') }}" class="form-control" step="any">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                		<div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="shipping_date" value="{{ old('shipping_date') }}" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.shippingitem')}}</label>
                                            <input type="text" name="shipping_item" value="{{ old('shipping_item') }}" class="form-control" placeholder="{{trans('file.shippingitem')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.salesperson')}}</label>
                                            <input type="text" name="sales_person" value="{{ old('sales_person') }}" class="form-control" placeholder="{{trans('file.salesperson')}}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="delivery_person" value="{{ old('delivery_person') }}" class="form-control" placeholder="{{trans('Deliver Person')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.deliveryplace')}}</label>
                                            <input type="text" name="delivery_place" value="{{ old('delivery_place') }}" class="form-control" placeholder="{{trans('file.deliveryplace')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
