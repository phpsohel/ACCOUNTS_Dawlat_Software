            ...
            <div class="col-md-12">
                <div class="card card-info">
                    <div class="card-header d-flex">
                            <h4 class="card-title">{{trans('file.updatechalan')}}</h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.vendor')}} <sup class="text-danger">*</sup></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.Biller')}} <sup class="text-danger">*</sup></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4" style="display: none">
                                        <div class="form-group">
                                            <label>{{trans('file.Warehouse')}} <sup class="text-danger">*</sup></label>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <h5>{{trans('file.Order Table')}} <sup class="text-danger">*</sup></h5>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.shippingdate')}}</label>
                                            <input type="date" name="shipping_date" value="{{ old('shipping_date',$lims_quotation_data->shipping_date) }}" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.shippingitem')}}</label>
                                            <input type="text" name="shipping_item" value="{{ old('shipping_item',$lims_quotation_data->shipping_item) }}" class="form-control" placeholder="{{trans('file.shippingitem')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.salesperson')}}</label>
                                            <input type="text" name="sales_person" value="{{ old('sales_person',$lims_quotation_data->sales_person) }}" class="form-control" placeholder="{{trans('file.salesperson')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.chalanstatus')}} *</label>
                                            ...
                                            <select name="quotation_status" class="form-control">
                                                <option value="1" {{ $lims_quotation_data->quotation_status == 1 ? "Selected":'' }}>{{trans('file.Pending')}}</option>
                                                <option value="2" {{ $lims_quotation_data->quotation_status == 2 ? "Selected":'' }}>{{trans('file.Sent')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.deliveryplace')}}</label>
                                            <input type="text" name="delivery_place" value="{{ old('delivery_place',$lims_quotation_data->delivery_place) }}" class="form-control" placeholder="{{trans('file.deliveryplace')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('Deliver Person')}}</label>
                                            <input type="text" name="delivery_person" value="{{ old('delivery_person',$lims_quotation_data->delivery_person) }}" class="form-control" placeholder="{{trans('Deliver Person')}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <a href="{{URL::Previous()}}" class="btn btn-info  "><i class="fa fa-undo px-2"></i> Back</a>
