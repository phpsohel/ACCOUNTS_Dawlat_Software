                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <div class="col-md-4" style="display: none">
                                    ...
                                    <div class="form-group" >
                                        <label>{{trans('file.Product Type')}} <sup class="text-danger">*</sup></strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Product Code')}} <sup class="text-danger">*</sup></strong> </label>
                                        <div class="input-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Product Name')}} <sup class="text-danger">*</sup></strong> </label>
                                ...
                                <div class="col-md-4" style="display: none">
                                    <div class="form-group">
                                        <label>{{trans('file.Barcode Symbology')}} <sup class="text-danger">*</sup></strong> </label>
                                        <div class="input-group">
                                ...
                                <div id="digital" class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Attach File')}} <sup class="text-danger">*</sup></strong> </label>
                                        <div class="input-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.category')}} <sup class="text-danger">*</sup></strong> </label>
                                        <div class="input-group">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label>{{trans('file.Product Unit')}} <sup class="text-danger">*</sup></strong> </label>
                                        <div class="input-group">
                                ...
                                <div id="qty" class="col-md-4">
                                    <div class="form-group">
                                       <label>{{trans('Product Quantity')}} <sup class="text-danger">*</sup></strong> </label>
                                       <input type="number" name="qty" value="{{ old('qty') }}" required  class="form-control" step="any">
                                       <span class="validation-msg"></span>
                                   </div>
                               </div>
                                <div id="cost" class="col-md-4">
                                    <div class="form-group">
                                       <label>{{trans('Purchase Price')}} <sup class="text-danger">*</sup></strong> </label>
                               ...
                               <div class="col-md-4">
                                   <div class="form-group">
                                       <label>{{trans('Sale Price')}} <sup class="text-danger">*</sup></strong> </label>
                            ...
                            <div class="form-group">
                                <a type="button" href="{{ URL::Previous() }}" class="btn btn-info"><i class="fa fa-undo px-2"></i>Back</a>
