                        ...
                        <table  class="table table-bordered table-sm table-striped text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-primary">{{(( $item->payable_amount ?? 0) - ($item->paid_amount?? 0))   ?? ''}}</td>
                                    <td>
                                        ...
                                        <div class="btn-group" >
                                            ...
                                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu" style="scroll:auto">
                                              ...
                                              <li> 
                                                ...
                                                <li>
                                                    <a class="btn btn-link voucher_details_data" data-toggle="modal" data-target="#bill_voucher_details_{{ $item->id }}" data-detailid="{{$item->id  }}"> <i class="fa fa-bath"></i>Voucher Details
                                                    </a>
                                                </li>
                                ...
                                @include('billinfo.bill_voucher_modal')
           ...
           error: function(response) {
               console.log(response);
                ...
                $(document).on('click', '.voucher_details_data', function() {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "{{ route('billWiseVoucherDetails') }}",
                        dataType: 'HTML',
                        data: {
                            bill_id:bill_id
                        },
