                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.System Title')}} <sup class="text-danger">*</sup></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.System Logo')}} <sup class="text-danger">*</sup></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="website_link" class="form-control" value="@if($lims_general_setting_data){{$lims_general_setting_data->website_link ?? ''}}@endif"  />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Currency')}} <sup class="text-danger">*</sup></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Currency Position')}} <sup class="text-danger">*</sup></label><br>
                                ...
                                <div class="col-md-6 d-none">
                                    <div class="form-group">
                                        <label>{{trans('file.Theme')}} <sup class="text-danger">*</sup></label>
                                        <div class="row ml-1">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Staff Access')}} <sup class="text-danger">*</sup></label>
                                        @if($lims_general_setting_data)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Invoice Format')}} <sup class="text-danger">*</sup></label>
                                        @if($lims_general_setting_data)
                                ...
                                <div id="state" class="col-md-6 d-none">
                                    <div class="form-group">
                                        <label>{{trans('file.State')}} <sup class="text-danger">*</sup></label>
                                        @if($lims_general_setting_data)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Date Format')}} <sup class="text-danger">*</sup></label>
                                        @if($lims_general_setting_data)
