...
<section>
	...
	<div class="col-md-6 offset-md-3 mt-4">
        <div class="form-group row">
            ...
            <hr>
            <div class="input-group-append">
                <a type="button" class="btn btn-primary" href="{{ route('export-pdf', ['start_date' => $start_date, 'end_date' => $end_date]) }}">PDF</a><br>     
            </div>

             <div class="input-group-append">
                 <a type="button" class="btn btn-primary" href="{{ route('summary-print', ['start_date' => $start_date, 'end_date' => $end_date]) }}">Print</a>
            </div>
			...
			<div class="col-md-4">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2">{{trans('file.profit')}} <span class="float-right"> {{number_format((float)$purchase[0]->grand_total, 2, '.', '')}}</span></p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
