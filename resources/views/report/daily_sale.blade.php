	...
	<div class="container-fluid">
		<div class="card"> 
			<div class="card-body"> 
				...
				{{--<select style="display: none" class="selectpicker" id="warehouse_id" name="warehouse_id">--}}
                ...
                <a type="button" class="btn btn-primary" href="{{ route('daily-sale-pdf', ['year' => $year, 'month' => $month]) }}">PDF</a><hr>

                <a type="button" class="btn btn-primary" href="{{ route('daily-sale-print', ['year' => $year, 'month' => $month]) }}">Print</a>
            	</div>
