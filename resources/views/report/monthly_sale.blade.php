	...
	<div class="container-fluid">
		<div class="card"> 
			<div class="card-body"> 
                ...
                <a type="button" class="btn btn-primary" href="{{ route('monthly-sale-pdf', ['year' => $year]) }}">PDF</a>
                
                <a type="button" class="btn btn-primary" href="{{ route('monthly-sale-print', ['year' => $year]) }}">Print</a>
            	</div>
