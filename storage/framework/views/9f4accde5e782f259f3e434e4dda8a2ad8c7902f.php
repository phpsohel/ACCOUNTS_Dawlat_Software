                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="heading">
                         ...
                         <form method="POST" action="<?php echo e(route('eshop-post-login')); ?>" id="login-form">
                         <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <form method="POST" action="<?php echo e(route('eshop-post-register')); ?>">
                         <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salepropos\resources\views/eshop/login.blade.php ENDPATH**/ ?>