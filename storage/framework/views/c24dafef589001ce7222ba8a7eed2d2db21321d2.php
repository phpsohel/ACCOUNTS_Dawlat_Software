            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => ['return-purchase.update', $lims_return_data->id], 'method' => 'put', 'files' => true, 'class' => 'payment-form']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="supplier_id_hidden" value="<?php echo e($lims_return_data->supplier_id); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required id="account_id" name="account_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select account...">
                                                <?php $__currentLoopData = $lims_account_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($account->id == $lims_return_data->account_id): ?>
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($product_return->variant_id) {
                                                            $product_variant_data = \App\ProductVariant::select('id', 'item_code')->FindExactProduct($product_return->product_id, $product_return->variant_id)->first();
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="net_unit_cost"><?php echo e(number_format((float)$product_return->net_unit_cost, 2, '.', '')); ?> </td>
                                                        ...
                                                        <input type="hidden" class="net_unit_cost" name="net_unit_cost[]" value="<?php echo e($product_return->net_unit_cost); ?>" />
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total"><?php echo e(number_format((float)$lims_return_data->total_cost, 2, '.', '')); ?></th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_cost" value="<?php echo e($lims_return_data->total_cost); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hisab\resources\views/return_purchase/edit.blade.php ENDPATH**/ ?>