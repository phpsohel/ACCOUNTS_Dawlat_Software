                ...
                <div class="row">
                    ...
                    <div class="col-md-6" id="closing-section">
                        <form action="<?php echo e(route('cashRegister.close')); ?>" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary" onclick="return confirmClose()"><?php echo e(trans('file.Close Register')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salepropos\resources\views/cash_register/index.blade.php ENDPATH**/ ?>