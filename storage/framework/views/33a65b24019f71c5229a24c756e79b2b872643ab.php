<div id="bill_voucher_details_<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;"><?php echo e(trans('Bill Wise Voucher Details')); ?></i>
                </div>
            </div>
        </div>
...
</div><?php /**PATH /home/acquqkkb/public_html/dawlatbd/resources/views/billinfo/bill_voucher_modal.blade.php ENDPATH**/ ?>