            ...
            <div class="col-md-6">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <td class="col-sm-4 product-title"><strong><?php echo e($product_data->name); ?></strong> [<?php echo e($product_data->code); ?>] <button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button> </td>
                                                    ...
                                                    <td class="col-sm-2 sub-total"><?php echo e(number_format((float)$product_sale->total, 2, '.', '')); ?></td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="sale_id" value="<?php echo e($lims_sale_data->id); ?>" />
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Items')); ?></span><span id="item"><?php echo e($lims_sale_data->item); ?> (<?php echo e($lims_sale_data->total_qty); ?>)</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Total')); ?></span><span id="subtotal"><?php echo e(number_format((float)$lims_sale_data->total_price, 2, '.', '')); ?></span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Discount')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-discount"> <i class="dripicons-document-edit"></i></button></span>
                                            <?php if($lims_sale_data->order_discount): ?>
                                            <span id="discount"><?php echo e(number_format((float)$lims_sale_data->order_discount, 2, '.', '')); ?></span>
                                            <?php else: ?>
                                            <span id="discount">0.00</span>
                                            <?php endif; ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Coupon')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#coupon-modal"><i class="dripicons-document-edit"></i></button></span>
                                            <?php if($lims_sale_data->coupon_discount): ?>
                                              <span id="coupon-text"><?php echo e(number_format((float)$lims_sale_data->coupon_discount, 2, '.', '')); ?></span>
                                            <?php else: ?>
                                              <span id="coupon-text">0.00</span>
                                            <?php endif; ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Tax')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-tax"><i class="dripicons-document-edit"></i></button></span>
                                            <?php if($lims_sale_data->order_tax): ?>
                                              <span id="tax"><?php echo e(number_format((float)$lims_sale_data->order_tax, 2, '.', '')); ?></span>
                                            <?php else: ?>
                                              <span id="tax">0.00</span>
                                            <?php endif; ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Shipping')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#shipping-cost-modal"><i class="dripicons-document-edit"></i></button></span>
                                            <?php if($lims_sale_data->shipping_cost): ?>
                                              <span id="shipping-cost"><?php echo e(number_format((float)$lims_sale_data->shipping_cost, 2, '.', '')); ?></span>
                                            <?php else: ?>
                                ...
                                <!-- <div class="form-group">
                                    <table class="table table-bordered table-condensed totals">
                                        <tr>
                                            ...
                                            <span id="item"><?php echo e($lims_sale_data->item); ?>( <?php echo e($lims_sale_data->total_qty); ?>)</span>
                                            </td>
                                            <td style="width:15%; padding: 0 0 0 10px; color: #000;"><strong><?php echo e(trans('file.Total')); ?></strong><br>
                                            <span id="subtotal"><?php echo e(number_format((float)($lims_sale_data->total_price), 2, '.', '')); ?></span>
                                            </td>
                                            <td style="width:15%; padding: 0 0 0 10px; color: #000;"><strong><?php echo e(trans('file.Discount')); ?></strong>
                                            ...
                                            <td style="width:15%; padding: 0 0 0 10px; color: #000;"><strong><?php echo e(trans('file.Tax')); ?></strong>
                                            ...
                                            <td style="width:15%; padding: 0 0 0 10px; color: #000;"><strong><?php echo e(trans('file.Shipping')); ?></strong>
                                            ...
                                            <td style="width:15%; padding: 0 0 0 10px; color: #000;"><strong><?php echo e(trans('file.grand total')); ?></strong><br>
                                            <span id="grand-total"><?php echo e(number_format((float)($lims_sale_data->grand_total), 2, '.', '')); ?></span>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                    ...
                    <div class="payment-amount">
                        <h2><?php echo e(trans('file.grand total')); ?> <span id="grand-total"><?php echo e(number_format((float)$lims_sale_data->grand_total, 2, '.', '')); ?></span></h2>
                    </div>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="order_discount" class="form-control numkey" step="any" value="<?php echo e(number_format((float)$lims_sale_data->order_discount, 2, '.', '')); ?>">
                            </div>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <?php if($lims_sale_data->coupon_id): ?>
                                    <input type="text" id="coupon-code" class="form-control" placeholder="Type Coupon Code..." value="<?php echo e($coupon->code); ?>" disabled>
                                <?php else: ?>
            ...
            <div id="shipping-cost-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="shipping_cost" class="form-control numkey" value="<?php echo e(number_format((float)($lims_sale_data->shipping_cost), 2, '.', '')); ?>" step="any">
                            </div>
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salepropos\resources\views/sale/create_sale.blade.php ENDPATH**/ ?>