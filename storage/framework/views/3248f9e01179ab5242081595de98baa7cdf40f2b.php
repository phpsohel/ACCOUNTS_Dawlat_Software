                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.System Title')); ?> <sup class="text-danger">*</sup></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.System Logo')); ?> <sup class="text-danger">*</sup></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="website_link" class="form-control" value="<?php if($lims_general_setting_data): ?><?php echo e($lims_general_setting_data->website_link ?? ''); ?><?php endif; ?>"  />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Currency')); ?> <sup class="text-danger">*</sup></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Currency Position')); ?> <sup class="text-danger">*</sup></label><br>
                                ...
                                <div class="col-md-6 d-none">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Theme')); ?> <sup class="text-danger">*</sup></label>
                                        <div class="row ml-1">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Staff Access')); ?> <sup class="text-danger">*</sup></label>
                                        <?php if($lims_general_setting_data): ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Invoice Format')); ?> <sup class="text-danger">*</sup></label>
                                        <?php if($lims_general_setting_data): ?>
                                ...
                                <div id="state" class="col-md-6 d-none">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.State')); ?> <sup class="text-danger">*</sup></label>
                                        <?php if($lims_general_setting_data): ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Date Format')); ?> <sup class="text-danger">*</sup></label>
                                        <?php if($lims_general_setting_data): ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/setting/general_setting.blade.php ENDPATH**/ ?>