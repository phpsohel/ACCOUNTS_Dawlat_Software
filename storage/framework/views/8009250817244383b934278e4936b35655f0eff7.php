                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_dimension" value="<?php echo e($lims_product_data->product_dimension ?? ''); ?>" class="form-control product_dimension" id="product_dimension" aria-describedby="name">
                            ...
                            <div class="col-md-4 mt-2">
                                ...
                                <div id="cost" class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Product Cost')); ?> <sup class="text-danger">*</sup></strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Product Price')); ?> <sup class="text-danger">*</sup></strong> </label>
                                ...
                                <div id="qty" class="col-md-4">
                                    <div class="form-group">
                                       ...
                                       <input type="number" name="qty" value="<?php echo e(old('qty',$lims_product_data->qty)); ?>" required  class="form-control" step="any">
                                       <span class="validation-msg"></span>
                                   </div>
                               </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/product/edit.blade.php ENDPATH**/ ?>