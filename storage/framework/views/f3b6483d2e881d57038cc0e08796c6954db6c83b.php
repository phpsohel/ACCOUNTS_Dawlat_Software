            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.Update Return')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        <?php echo Form::open(['route' => ['return-sale.update', $lims_return_data->id], 'method' => 'put', 'files' => true, 'id' => 'payment-form']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p><strong><?php echo e($lims_return_data->reference_no); ?></strong></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.customer')); ?> *</label>
                                            <input type="hidden" name="customer_id_hidden" value="<?php echo e($lims_return_data->customer_id); ?>" />
                                ...
                                <div class="row">
                                    <div class="col-md-6" style="display: none">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="warehouse_id_hidden" value="<?php echo e($lims_return_data->warehouse_id); ?>" />
                                    ...
                                    <div class="col-md-6" style="display: none">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="biller_id_hidden" value="<?php echo e($lims_return_data->biller_id); ?>" />
                                            <select required name="biller_id" class="form-control">
                                                ...
                                                <option value="1"><?php echo e($biller->name . ' (' . $biller->company_name . ')'); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                    <?php $__currentLoopData = $lims_product_return_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_return): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                    <?php 
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><input type="number" class="form-control qty" name="qty[]" value="<?php echo e($product_return->qty); ?>" required step="any" /></td>
                                                        <td class="net_unit_price"><?php echo e(number_format((float)$product_return->net_unit_price, 2, '.', '')); ?> </td>
                                                        <td class="discount"><?php echo e(number_format((float)$product_return->discount, 2, '.', '')); ?></td>
                                                        <td class="tax"><?php echo e(number_format((float)$product_return->tax, 2, '.', '')); ?></td>
                                                        <td class="sub-total"><?php echo e(number_format((float)$product_return->total, 2, '.', '')); ?></td>
                                                        ...
                                                        <input type="hidden" class="net_unit_price" name="net_unit_price[]" value="<?php echo e($product_return->net_unit_price); ?>" />
                                                        <input type="hidden" class="discount-value" name="discount[]" value="<?php echo e($product_return->discount); ?>" />
                                                        <input type="hidden" class="tax-rate" name="tax_rate[]" value="<?php echo e($product_return->tax_rate); ?>"/>
                                                        <?php if($tax): ?>
                                                        ...
                                                        <input type="hidden" class="tax-value" name="tax[]" value="<?php echo e($product_return->tax); ?>" />
                                                        <input type="hidden" class="subtotal-value" name="subtotal[]" value="<?php echo e($product_return->total); ?>" />
                                                    </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                                <tfoot class="tfoot active">
                                                    <th colspan="2"><?php echo e(trans('file.Total')); ?></th>
                                                    <th id="total-qty"><?php echo e($lims_return_data->total_qty); ?></th>
                                                    <th></th>
                                                    <th id="total-discount"><?php echo e(number_format((float)$lims_return_data->total_discount, 2, '.', '')); ?></th>
                                                    <th id="total-tax"><?php echo e(number_format((float)$lims_return_data->total_tax, 2, '.', '')); ?></th>
                                                    <th id="total"><?php echo e(number_format((float)$lims_return_data->total_price, 2, '.', '')); ?></th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_qty" value="<?php echo e($lims_return_data->total_qty); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount" value="<?php echo e($lims_return_data->total_discount); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_tax" value="<?php echo e($lims_return_data->total_tax); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_price" value="<?php echo e($lims_return_data->total_price); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="item" value="<?php echo e($lims_return_data->item); ?>" />
                                            <input type="hidden" name="order_tax" value="<?php echo e($lims_return_data->order_tax); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="grand_total" value="<?php echo e($lims_return_data->grand_total); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="hidden" name="order_tax_rate_hidden" value="<?php echo e($lims_return_data->order_tax_rate); ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Return Note')); ?></label>
                                            <textarea rows="5" class="form-control" name="return_note" ><?php echo e($lims_return_data->return_note); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Staff Note')); ?></label>
                                            <textarea rows="5" class="form-control" name="staff_note"><?php echo e($lims_return_data->staff_note); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hisab\resources\views/return/edit.blade.php ENDPATH**/ ?>