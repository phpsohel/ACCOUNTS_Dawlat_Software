...
<section>
    ...
    <div class="card">
        <div class="card-header">
            <a href="<?php echo e(route('salesperson.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('Add Sales Person')); ?></a>&nbsp;
        </div>
        <div class="card-body">
            <div class="row">
                        ...
                        <table  class="table table-bordered table-sm table-striped text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($sale->phone_number ?? ''); ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                ...
                                                <li> 
                                                    <a href="<?php echo e(route('salesperson.edit', $sale->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                                </li>
                                              
                                          
                                                <li>
                                                    <a class="btn btn-link" data-toggle="modal" data-target="#myModal<?php echo e($sale->id); ?>"> <i class="fa fa-trash"></i>Delete
                                                    </a>
                                                </li>
                                ...
                                <?php echo $__env->make('salesperson.deleted_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/salesperson/index.blade.php ENDPATH**/ ?>