                    ...
                    <div class="table-responsive">
                        <table  class="table table-bordered table-sm table-striped text-nowrap">
                            ...
                            <tbody>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                ...
                                                <li> 
                                                    ...
                                                    <a class="btn btn-link" data-toggle="modal" data-target="#approved<?php echo e($item->id); ?>"> <i class="fa fa-hand-o-right"></i>Approve
                                                    </a>
                                                </li>
                                ...
                                <?php echo $__env->make('challaninfo.approved_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/dawlatbd/resources/views/challaninfo/pending_challan_list.blade.php ENDPATH**/ ?>