		...
		<div class="card"> 
			<div class="card-body"> 
				...
				<div class="input-group-append">
                	<a type="button" class="btn btn-primary" href="<?php echo e(route('daily-purchase-pdf', ['year' => $year, 'month' => $month])); ?>">PDF</a>

                	<a type="button" class="btn btn-primary" href="<?php echo e(route('daily-purchase-print', ['year' => $year, 'month' => $month])); ?>">Print</a>
            	</div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salepropos\resources\views/report/daily_purchase.blade.php ENDPATH**/ ?>