...
<div class="clearfix">
  ...
  <div class="box1" style="margin-top: 50px">
    <div class="" style="text-align: right">
        ...
        <div class="upper_case"> <?php echo e(\Carbon\Carbon::parse($item->payment_date)->format('F d, Y')); ?> / <?php echo e(\Carbon\Carbon::parse($item->payment_date)->format('l')); ?> <?php echo e(\Carbon\Carbon::parse($item->created_at)->format('H:i')); ?></div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  <tfoot>
      ...
      <td class=""></td>
      <td class=""></td>
  	  <th class="upper_case  text_right "  style="background-color: rgb(228, 225, 225);"><?php echo e(number_format(number_format((float)($sub_total ?? 0),2,'.',''),2)); ?></th>
...
</html><?php /**PATH /home/acquqkkb/public_html/dawlatbd/resources/views/voucherinfo/voucher_pdf_receipt.blade.php ENDPATH**/ ?>