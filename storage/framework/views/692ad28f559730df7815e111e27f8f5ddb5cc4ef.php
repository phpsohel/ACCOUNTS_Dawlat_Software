...
<script type="text/javascript" src="<?php echo asset('public/js/front.js') ?>"></script>
  ...
  <body>
    ...
    <div class="page login-page" style="background: url('<?php echo e(asset('public/logo/acquainttechnologies.png')); ?>'); background-size: cover;">
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner text-center">
            <div class="logo"><?php if($general_setting->site_logo): ?><img src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" width="200">&nbsp;&nbsp;<?php endif; ?></div>
          ...
          <div class="copyrights text-center">
            <p style='color:black;'><?php echo e(trans('file.Developed By')); ?> <span class="external"><?php echo e($general_setting->developed_by); ?></span></p>
          </div>
        </div>
      </div>
    </div>
...
</script><?php /**PATH /home/acquqkkb/public_html/dawlatbd/resources/views/auth/login.blade.php ENDPATH**/ ?>