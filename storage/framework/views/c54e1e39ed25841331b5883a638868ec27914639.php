...
<section>
	<div class="container-fluid">
		<div class="card"> 
			<div class="card-body"> 
				<?php echo e(Form::open(['route' => ['report.monthlySaleByWarehouse', $year], 'method' => 'post', 'id' => 'report-form'])); ?>

				<input type="hidden" name="warehouse_id_hidden" value="<?php echo e($warehouse_id); ?>">
				<h4 class="text-center"><?php echo e(trans('file.Monthly Sale Report')); ?> &nbsp;&nbsp;
                ...
                <a type="button" class="btn btn-primary" href="<?php echo e(route('monthly-sale-pdf', ['year' => $year])); ?>">PDF</a>
                
                <a type="button" class="btn btn-primary" href="<?php echo e(route('monthly-sale-print', ['year' => $year])); ?>">Print</a>
            	</div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/hisab/resources/views/report/monthly_sale.blade.php ENDPATH**/ ?>