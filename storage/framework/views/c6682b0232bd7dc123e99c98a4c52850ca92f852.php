                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <div class="col-md-4" style="display: none">
                                    ...
                                    <div class="form-group" >
                                        <label><?php echo e(trans('file.Product Type')); ?> <sup class="text-danger">*</sup></strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Product Code')); ?> <sup class="text-danger">*</sup></strong> </label>
                                        <div class="input-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Product Name')); ?> <sup class="text-danger">*</sup></strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Product Dimension </strong> </label>
                                        <input type="text" name="product_dimension" class="form-control product_dimension" id="product_dimension" aria-describedby="name">
                                        <span class="validation-msg" id="product_dimension-error"></span>
                                    </div>
                                </div>
                            
                                <div class="col-md-4" style="display: none">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Barcode Symbology')); ?> <sup class="text-danger">*</sup></strong> </label>
                                        <div class="input-group">
                                ...
                                <div id="digital" class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Attach File')); ?> <sup class="text-danger">*</sup></strong> </label>
                                        <div class="input-group">
                                ...
                                <div class="col-md-4" style="display: none;">
                                    <div class="form-group">
                                        <label>Color <sup class="text-danger">*</sup></strong> </label>
                                        <div class="input-group">
                                            <select name="color" required class="form-control selectpicker">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.category')); ?> <sup class="text-danger">*</sup></strong> </label>
                                        <div class="input-group">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label><?php echo e(trans('file.Product Unit')); ?> <sup class="text-danger">*</sup></strong> </label>
                                        <div class="input-group">
                                ...
                                <div id="qty" class="col-md-4">
                                    <div class="form-group">
                                       <label><?php echo e(trans('Product Quantity')); ?> <sup class="text-danger">*</sup></strong> </label>
                                       <input type="number" name="qty" value="<?php echo e(old('qty')); ?>" required  class="form-control" step="any">
                                       <span class="validation-msg"></span>
                                   </div>
                               </div>
                                <div id="cost" class="col-md-4">
                                    <div class="form-group">
                                       <label><?php echo e(trans('Purchase Price')); ?> <sup class="text-danger">*</sup></strong> </label>
                               ...
                               <div class="col-md-4">
                                   <div class="form-group">
                                       <label><?php echo e(trans('Sale Price')); ?> <sup class="text-danger">*</sup></strong> </label>
                            ...
                            <div class="form-group">
                                <a type="button" href="<?php echo e(URL::Previous()); ?>" class="btn btn-info"><i class="fa fa-undo px-2"></i>Back</a>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/product/create.blade.php ENDPATH**/ ?>