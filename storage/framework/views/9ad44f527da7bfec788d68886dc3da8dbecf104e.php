                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="" required class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="designation" value="<?php echo e(old('designation')); ?>" required class="form-control">
                            ...
                            <div class="col-md-6">   
                                <div class="form-group">
                                    ...
                                    <input type="text" name="website_link" value="<?php echo e(old('website_link')); ?>"  placeholder="" class="form-control">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/biller/create.blade.php ENDPATH**/ ?>