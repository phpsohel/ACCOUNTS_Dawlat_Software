...
<section>
    <div class="container-fluid">
        <?php if(in_array("customers-add", $all_permission)): ?>
            <a href="<?php echo e(route('customer.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.Addvendor')); ?></a>&nbsp;
        ...
        <table id="customer-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.vendorname')); ?></th>
                    <th><?php echo e(trans('Brand Name')); ?></th>
                    <th><?php echo e(trans('Contact Person')); ?></th>
                    <th><?php echo e(trans('Designation')); ?></th>
                    <th><?php echo e(trans('file.Email')); ?></th>
                    <th><?php echo e(trans('file.Phone Number')); ?></th>
                    <th><?php echo e(trans('file.Address')); ?></th>
                    <th><?php echo e(trans('Sales Person')); ?></th>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.importvendor')); ?></h5>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/customer/index.blade.php ENDPATH**/ ?>