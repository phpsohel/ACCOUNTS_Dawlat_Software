    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button id="print-btn" type="button" class="btn btn-default btn-sm ml-3 " disabled><i class="dripicons-print"></i> <?php echo e(trans('file.Print')); ?></button>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/product/index.blade.php ENDPATH**/ ?>