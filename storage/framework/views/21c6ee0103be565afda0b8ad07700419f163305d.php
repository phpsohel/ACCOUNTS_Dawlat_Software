...
<body>
            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left header-dropdowns">
                        <div class="">
                            <a href="<?php echo e(route('eshop-category-page')); ?>">ALL CATEGORIES</a>
                    ...
                    <div class="header-right">
                        ...
                        <div class="header-dropdown dropdown-expanded">
                            ...
                            <div class="header-menu">
                                <ul>
                                    <li><a href="<?php echo e(route('eshop-blogs')); ?>">BLOG</a></li>
                                    <?php if(Auth::user()): ?>
                                    <?php if(Auth::user()->role_id == 5): ?>
                                    <li><a href="<?php echo e(route('eshop-profile')); ?>">MY ACCOUNT </a></li>
                                    <?php endif; ?>
                                    <?php endif; ?>
                                   ...
                                   <?php if(!Auth::user()): ?>
                                    ...
                                    <li><a href="<?php echo e(route('eshop-login')); ?>" class="">LOG IN</a>
                                    </li>
                                   ...
                                   <?php endif; ?>
                                    <?php if(Auth::user()): ?>
                                    <?php if(Auth::user()->role_id == 5): ?>
                                    <li><a href="<?php echo e(route('logout')); ?>" class=""  onclick="event.preventDefault();
            ...
            <div class="header-middle">
                <div class="container">
                    <div class="header-left">
                        <a href="<?php echo e(route('eshop')); ?>" class="logo">
                            <img src="<?php echo e(asset('/')); ?>public/assets/frontend/images/logo.png" alt="Porto Logo">
                        </a>
                    </div><!-- End .header-left -->
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="#"><?php echo e($row->product->name); ?></a>
                                                </h4>
                ...
                <div class="container">
                    <nav class="main-nav">
                        <ul class="menu sf-arrows">
                            <li class="active"><a href="<?php echo e(route('eshop')); ?>">Home</a></li>
                            <li>
                            ...
                            <?php $__currentLoopData = $cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="megamenu-container">
                                <a href="<?php echo e(route('all-categories', $key->id)); ?>" class=""><?php echo e($key->name); ?></a>
                           ...
                           <!--  <li><a href="#" class="sf-with-ul">Features</a>
                            ...
                            <li class="float-right"><a href="<?php echo e(route('eshop-offer')); ?>">Special Offer!</a></li>
                        </ul>
                    </nav>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                                            ...
                                            <div class="col-sm-6 col-md-5">
                                                <ul class="links">
                                                    ...
                                                    <li><a href="<?php echo e(route('contact')); ?>">Contact Us</a></li>
                                                     <li><a href="<?php echo e(route('eshop-login')); ?>">Login</a></li>
                                                    <!-- <li><a href="<?php echo e(route('eshop-profile')); ?>">My Account</a></li> -->
                                                </ul>
                                            </div><!-- End .col-sm-6 -->
                                    ...
                                    <div class="widget">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <ul class="links">
                                                     <?php $__currentLoopData = $cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><a href="<?php echo e(route('all-categories', $key->id)); ?>"><?php echo e($key->name); ?></a></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <ul class="links">
                                                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><a href="<?php echo e(route('brands-product', $val->id)); ?>"><?php echo e($val->title); ?></a></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="footer-bottom">
                                ...
                                <!-- <img src="<?php echo e(asset('/')); ?>public/assets/frontend/images/payments.png" alt="payment methods" class="footer-payments"> -->
        ...
        <div class="mobile-menu-wrapper">
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    ...
                    <li>
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('eshop-category-page')); ?>"><?php echo e($row->name); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li><a href="<?php echo e(route('contact')); ?>">Contact Us</a></li>
                    <li><a href="<?php echo e(route('eshop-offer')); ?>">Special Offer!<span class="tip tip-hot">Hot!</span></a></li>
   ...
   <!--  <div class="newsletter-popup mfp-hide" id="newsletter-popup-form" style="background-image: url(<?php echo e(asset('/')); ?>public/assets/frontend/images/newsletter_popup_bg.jpg)">
        <div class="newsletter-popup-content">
            <img src="<?php echo e(asset('/')); ?>public/assets/frontend/images/logo-black.png" alt="Logo" class="logo-newsletter">
        ...
        <div class="modal-content">
          <div class="modal-body add-cart-box text-center">
            ...
            <div class="btn-actions">
                <a href="<?php echo e(route('cart-page')); ?>"><button class="btn-primary">Go to cart page</button></a>
...
</html><?php /**PATH C:\xampp\htdocs\salepropos\resources\views/layout/website.blade.php ENDPATH**/ ?>