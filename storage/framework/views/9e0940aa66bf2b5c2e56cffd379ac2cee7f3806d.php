            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span><?php echo e(__('file.product')); ?></span><span></a>
                <ul id="product" class="collapse list-unstyled ">
                  <li id="category-menu"><a href="<?php echo e(route('add-color')); ?>">Color</a></li>
              ...
              <?php endif; ?>
               ...
               <li><a href="#website" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user"></i><span>Website</span></a>
                <ul id="website" class="collapse list-unstyled ">
                  
                  <?php if($user_index_permission_active): ?>
                  <li id="user-list-menu"><a href="<?php echo e(route('add-blog')); ?>">Add Blog</a></li>
                  <li id="user-list-menu"><a href="<?php echo e(route('blog-list')); ?>">Blog List</a></li>
                  <?php endif; ?>   
                </ul>
              </li>
                ...
                <ul id="report" class="collapse list-unstyled ">
                  ...
                  <?php endif; ?>
                   <li id="">
                    ...
                    <a id="" href="<?php echo e(route('expire-report')); ?>">Expire Report</a>
                    
                  </li>
                   <li id="">
              
                    <a id="" href="<?php echo e(route('customers-message')); ?>">Customers Message</a>
                    
                  </li>
                  <li id="">
              
                    <a id="" href="<?php echo e(route('view-newsletter')); ?>">Newsletter</a>
              ...
              <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span><?php echo e(trans('file.settings')); ?></span></a>
                <ul id="setting" class="collapse list-unstyled ">
                  ...
                  <?php endif; ?>
                   ...
                   <?php if($general_setting_permission_active): ?>
                  <li id="general-setting-menu"><a href="<?php echo e(route('setting.report')); ?>">Report Setting</a></li>
                  <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\salepropos\resources\views/layout/main.blade.php ENDPATH**/ ?>