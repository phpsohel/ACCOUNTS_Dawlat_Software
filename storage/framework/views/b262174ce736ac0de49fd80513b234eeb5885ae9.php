                                    ...
                                    <div class="product-slider-container product-item">
                                        <div class="product-single-carousel owl-carousel owl-theme">
                                            <div class="product-item">
                                                <img class="product-single-image" src="<?php echo e(url('public/images/product', $product->image)); ?>" style="height: auto; width: 400px;" data-zoom-image="<?php echo e(url('public/images/product', $product->image)); ?>"/>
                                            </div>
                                ...
                                <div class="col-lg-5 col-md-6">
                                    <div class="product-single-details">
                                        ...
                                        <div class="product-desc">
                                            <textarea style="display: none;" id="editorCopy" name="body"><?php echo e(\Illuminate\Support\Str::limit($product->product_details, 250, '..........')); ?></textarea>
                                        ...
                                        <form action="<?php echo e(route('add-cart-quantity', $product->id)); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                    ...
                    <aside class="sidebar-product col-lg-3 padding-left-lg mobile-sidebar">
                        <div class="sidebar-wrapper">
                            <div class="widget widget-brand">
                                <a href="<?php echo e(route('brands-product', $product->brand_id)); ?>">
                                    <img src="<?php echo e(url('public/images/brand', $product->brand_image)); ?>" alt="brand name">
                                </a>
                            </div><!-- End .widget -->
                        ...
                        <!--     <div class="widget widget-banner">
                                <div class="banner banner-image">
                                    <a href="#">
                                        <img src="<?php echo e(asset('/')); ?>public/assets/frontend/images/banners/banner-sidebar.jpg" alt="Banner Desc">
                                    </a>
                                </div><!-- End .banner 
                            </div><!-- End .widget -->
...
<?php echo $__env->make('layout.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salepropos\resources\views/eshop/detail.blade.php ENDPATH**/ ?>