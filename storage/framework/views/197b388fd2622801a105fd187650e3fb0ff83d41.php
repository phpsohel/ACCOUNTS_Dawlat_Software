<?php $__env->startSection('home_content'); ?>
  ...
  <main class="main">
            <div class="banner banner-cat" style="background-image: url('<?php echo e(asset('/')); ?>public/assets/frontend/images/banners/banner-top.jpg');">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <div class="row row-sm">
                            ...
                            <?php if($discount->count() > 0): ?>
                            <?php $__currentLoopData = $discount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="product-default">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="price-box">
                                         ...
                                         <form action="<?php echo e(route('eshop-detail', $row->id)); ?>" method="get">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salepropos\resources\views/eshop/offer.blade.php ENDPATH**/ ?>