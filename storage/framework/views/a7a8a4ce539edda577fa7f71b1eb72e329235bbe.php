...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="" style="">
    <?php echo '<img style="margin-top:15px;width:80%;margin-left:10%" src="data:image/png;base64,' . DNS1D::getBarcodePNG($bill->payable_amount, 'C128') . '" width="300" alt="barcode"   />';?>
  </div>
<div class="clearfix">
...
</html><?php /**PATH C:\laragon\www\dawlatbd\resources\views/billinfo/bill_pdf_invoice.blade.php ENDPATH**/ ?>