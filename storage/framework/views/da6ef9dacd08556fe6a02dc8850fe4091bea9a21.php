                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="customer_id" name="customer_id" required class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select Vendor...">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="display: none">
                                        <div class="form-group">
                                            ...
                                            <select id="warehouse_id" name="warehouse_id"  class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select warehouse...">
		                        ...
		                        <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="shipping_date" value="<?php echo e(old('shipping_date')); ?>" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.shippingitem')); ?></label>
                                            <input type="text" name="shipping_item" value="<?php echo e(old('shipping_item')); ?>" class="form-control" placeholder="<?php echo e(trans('file.shippingitem')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.salesperson')); ?></label>
                                            <input type="text" name="sales_person" value="<?php echo e(old('sales_person')); ?>" class="form-control" placeholder="<?php echo e(trans('file.salesperson')); ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="delivery_person" value="<?php echo e(old('delivery_person')); ?>" class="form-control" placeholder="<?php echo e(trans('Deliver Person')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.deliveryplace')); ?></label>
                                            <input type="text" name="delivery_place" value="<?php echo e(old('delivery_place')); ?>" class="form-control" placeholder="<?php echo e(trans('file.deliveryplace')); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag){
                ...
                cols += '<td>' + data[0] + '<button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal3"></button></td>';
                cols += '<td>' + data[1] + '</td>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/quotation/create.blade.php ENDPATH**/ ?>