...
<section>
    ...
    <div class="card">
        ...
        <div class="card-body invoice_details">
         <?php echo Form::open(['route' => ['voucherinfo.update',$item->id], 'method' => 'put', 'files' => true]); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="voucher_no" value="<?php echo e($item->voucher_no ?? ''); ?>"  readonly>

                                    <input type="hidden" class="form-control" name="bill_id" value="<?php echo e($item->bill_id ?? ''); ?>" >
                   
                                    <input type="hidden" class="form-control" name="vendor_id"  value="<?php echo e($item->vendor_id ?? 0); ?>">

                        
                                    <?php if($errors->has('voucher_no')): ?>
                                    <span>
                                        <span class="text-danger"><?php echo e($errors->first('voucher_no')); ?></span>
                                    </span>
                                    <?php endif; ?>

                                </div>
                                <div class="form-group">
                                    <label><?php echo e(trans('Payment Type')); ?> </label>
                                    <select name="payment_type" id="" class="form-control payment_type">
                                        <option value="1" <?php echo e($item->payment_type == 1 ? "Selected":''); ?>>Cash</option>
                                        <option value="2" <?php echo e($item->payment_type == 2 ? "Selected":''); ?>>Bank / Cheque</option>
                                  
                                    </select>
                                </div>
                                <?php if($item->payment_type == 2): ?>
                                <div class="form-group bank_name">
                                    <label><?php echo e(trans('Bank Name')); ?> </label>
                                    <input type="text" class="form-control" name="bank_name" value="<?php echo e(old('bank_name',$item->bank_name ?? '')); ?>">
                                </div>
                                <div class="form-group branch_name">
                                    <label><?php echo e(trans('Branch Name')); ?> </label>
                                    <input type="text" class="form-control" name="branch_name" value="<?php echo e(old('branch_name',$item->branch_name ?? '')); ?>">
                                </div>
                                <div class="form-group cheque_number">
                                    <label><?php echo e(trans('Cheque Number')); ?> </label>
                                    <input type="text" class="form-control" name="cheque_number" value="<?php echo e(old('cheque_number',$item->cheque_number ?? '')); ?>">
                                </div>
                                <?php endif; ?>
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div class="form-group">
                                    <h3 class="text-info">Due Amount   ( <?php echo e(($item->bill->payable_amount ?? 0) - ($item->bill->paid_amount?? 0)); ?> )</h3>
                                </div>
                                <div class="form-group">
                                    <h3 class="text-primary">Payment Date</h3>
                                <div class="">
                                    <input type="date" class="form-control" value="<?php echo e($item->payment_date ?? ''); ?>" name="payment_date" required>
                                </div>
                                ...
                                <div class="">
                                        <select name="billing_status" id="" class=" form-control billing_status">
                                            <option value="1" <?php echo e($item->bill->billing_status == 1 ? "Selected":''); ?>>Pending</option>
                                            <option value="2" <?php echo e($item->bill->billing_status == 2 ? "Selected":''); ?>>Pertially Paid</option>
                                            <option value="3" <?php echo e($item->bill->billing_status == 3 ? "Selected":''); ?>>Paid</option>
                                        </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <label><?php echo e(trans('Remarks')); ?> </label>
                                    <textarea  class="form-control" id="" cols="" style="border:1px solid gray" rows="3" name="remarks"><?php echo $item->remarks ?? ''; ?></textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive mt-3">
                                    <table id="myTable" class="table table-hover order-list">
                                        ...
                                        <tbody class="addtbody_append">
                                            ...
                                            ?>
                                            <tr class="">
                                                <td class=""><input type="text" class="form-control notes_values" value="<?php echo e($detail->notes_values ?? ''); ?>" name="notes_values[]" ></td>
                                                <td class=""><input type="text" class="form-control no_of_notes" name="no_of_notes[]"  value="<?php echo e($detail->no_of_notes ?? ''); ?>"></td>
                                                <td class=""><input type="text" class="form-control paid_amount text-right" name="paid_amount[]" value="<?php echo e($detail->paid_amount ?? ''); ?>" readonly></td>
                                                <td class=""></td>
                                            </tr>
                                        ...
                                        <tr class="">
                                            ...
                                            <td id="grand_total" >
                                                ...
                                                <input type="text" name="payable_amount" class="form-control grand_total text-right mx-2" value="<?php echo e(number_format((float)($total ?? 0),2,'.','')); ?>" readonly>
                                            </td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/voucherinfo/edit.blade.php ENDPATH**/ ?>