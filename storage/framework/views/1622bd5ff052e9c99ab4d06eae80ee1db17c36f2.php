            ...
            <div class="col-md-12">
                <div class="card card-info">
                    <div class="card-header d-flex">
                            <h4 class="card-title"><?php echo e(trans('file.updatechalan')); ?></h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.vendor')); ?> <sup class="text-danger">*</sup></label>
                                            <input type="hidden" name="customer_id_hidden" value="<?php echo e($lims_quotation_data->customer_id); ?>" />
                                            <select required id="customer_id" name="customer_id" class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select Vendor...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Biller')); ?> <sup class="text-danger">*</sup></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4" style="display: none">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Warehouse')); ?> <sup class="text-danger">*</sup></label>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="search-box input-group">
                                            ...
                                            <input type="text" name="product_code_name" id="lims_productcodeSearch" placeholder="Please type product code and Product Name" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <h5><?php echo e(trans('file.Order Table')); ?> <sup class="text-danger">*</sup></h5>
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <td><?php echo e($product_data->name); ?> 
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.shippingdate')); ?></label>
                                            <input type="date" name="shipping_date" value="<?php echo e(old('shipping_date',$lims_quotation_data->shipping_date)); ?>" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.shippingitem')); ?></label>
                                            <input type="text" name="shipping_item" value="<?php echo e(old('shipping_item',$lims_quotation_data->shipping_item)); ?>" class="form-control" placeholder="<?php echo e(trans('file.shippingitem')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.salesperson')); ?></label>
                                            <input type="text" name="sales_person" value="<?php echo e(old('sales_person',$lims_quotation_data->sales_person)); ?>" class="form-control" placeholder="<?php echo e(trans('file.salesperson')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.chalanstatus')); ?> *</label>
                                            ...
                                            <select name="quotation_status" class="form-control">
                                                <option value="1" <?php echo e($lims_quotation_data->quotation_status == 1 ? "Selected":''); ?>><?php echo e(trans('file.Pending')); ?></option>
                                                <option value="2" <?php echo e($lims_quotation_data->quotation_status == 2 ? "Selected":''); ?>><?php echo e(trans('file.Sent')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.deliveryplace')); ?></label>
                                            <input type="text" name="delivery_place" value="<?php echo e(old('delivery_place',$lims_quotation_data->delivery_place)); ?>" class="form-control" placeholder="<?php echo e(trans('file.deliveryplace')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Deliver Person')); ?></label>
                                            <input type="text" name="delivery_person" value="<?php echo e(old('delivery_person',$lims_quotation_data->delivery_person)); ?>" class="form-control" placeholder="<?php echo e(trans('Deliver Person')); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <a href="<?php echo e(URL::Previous()); ?>" class="btn btn-info  "><i class="fa fa-undo px-2"></i> Back</a>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/quotation/edit.blade.php ENDPATH**/ ?>