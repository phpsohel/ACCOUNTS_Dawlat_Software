...
<script type="text/javascript">
    ...
    function transferDetails(transfer) {
        ...
        $.get('transfers/product_transfer/' + transfer[3], function(data) {
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=5><strong style="float:right;"><?php echo e(trans("file.Shipping Cost")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=5><strong style="float:right;"><?php echo e(trans("file.grand total")); ?>:</strong></td>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salepropos\resources\views/transfer/index.blade.php ENDPATH**/ ?>