  ...
  <main class="main">
            <div class="banner banner-cat" style="background-image: url('<?php echo e(asset('/')); ?>public/images/category/<?php echo e($cat_name->image); ?>');">
                <div class="banner-content container">
                    <h2 class="banner-subtitle"><?php echo e($brand_name->title); ?></h2>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb mt-0">
                        ...
                        <li class="breadcrumb-item"><a href="#"> <?php echo e($cat_name->name); ?></a></li>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <div class="row row-sm">
                            ...
                            <?php $__currentLoopData = $brand_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <nav class="toolbox toolbox-pagination">
                            ...
                            <ul class="pagination">
                               <?php echo e($brand_products->links()); ?>
...
<?php echo $__env->make('layout.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salepropos\resources\views/eshop/brand.blade.php ENDPATH**/ ?>