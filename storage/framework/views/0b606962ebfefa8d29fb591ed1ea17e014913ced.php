            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><?php echo e(trans('Update Challan')); ?></h4>
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => ['challaninfo.update',$item->id], 'method' => 'put', 'files' => true, 'id' => 'quotation-form']); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p class=""><?php echo e($item->challan_no ?? ''); ?></p>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="vendor_customer_id" name="vendor_customer_id" required class="selectpicker form-control vendor_customer_id" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select Vendor...">
                                                ...
                                                <option value="<?php echo e($customer->id); ?>" <?php echo e($customer->id == $item->vendor_customer_id ? "Selected":''); ?>><?php echo e($customer->company_name ?? ''); ?></option>
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="biller_id" class="selectpicker form-control" data-live-search="true" id="biller-id" data-live-search-style="begins" title="Select Biller...">
                                                ...
                                                <option value="<?php echo e($biller->id); ?>" <?php echo e($biller->id == $item->biller_id ? "Selected":''); ?>><?php echo e($biller->name  ?? ''); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control sales_person" name="sales_person" value="<?php echo e(old('sales_person',$item->sales_person)); ?>" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control delivery_person" name="delivery_person" value="<?php echo e(old('delivery_person',$item->delivery_person)); ?>" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="delivery_place" value="<?php echo e(old('delivery_place',$item->delivery_place)); ?>" class="form-control" placeholder="<?php echo e(trans('file.deliveryplace')); ?>" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="shipping_date" value="<?php echo e($item->shipping_date ?? ''); ?>" class="form-control" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="shipping_item" value="<?php echo e(old('shipping_item',$item->shipping_item)); ?>" class="form-control shipping_item" placeholder="<?php echo e(trans('file.shippingitem')); ?>" required>
		                                ...
		                                <div class="table-responsive mt-3">
		                                    <table id="myTable" class="table table-hover order-list">
		                                        ...
		                                        <tbody class="addtbody ">
                                                    ...
                                                    ?>
                                                    <tr class="">
                                                        <td><input type="text" class="form-control" name="po_number[]" value="<?php echo e(old('po_number',$detail->po_number ?? '')); ?>" placeholder="" required></td>
                                                        <td>
                                                          
                                                            <textarea name="item_details[]" class="form-control" rows="3" placeholder=""><?php echo $detail->item_details ?? ''; ?></textarea>
                                                        </td>
                                                        <td><input type="text" class="form-control qty" onkeyup="qtycal(this)"  name="qty[]" value="<?php echo e($detail->qty ?? ''); ?>" required></td>
                                                        <td></td>
                                                       </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		                                        ...
		                                        <tfoot class="tfoot active">
		                                            ...
		                                            <td id="total-qty" class="">
                                                        <input type="text" name="total_qty" class="form-control total_qty" value="<?php echo e($total_qty ?? ''); ?>" readonly>
                                                    </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var x = 1;
        var fieldHtml = '<tr class=""><th><input type="text" class="form-control" name="po_number[]" value="<?php echo e(old('po_number')); ?>" ></th><th width="280px"><textarea name="item_details[]" class="form-control" rows="3"></textarea></th><th><input type="text" class="form-control qty" name="qty[]" onkeyup="qtycal(this)"></th><th><button type="button" class="btn btn-danger btn-sm delete_class remove" onclick="SubRowNum()">X</button></th></tr>';
        if (x < maxField) {
        x++;
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/challaninfo/edit.blade.php ENDPATH**/ ?>