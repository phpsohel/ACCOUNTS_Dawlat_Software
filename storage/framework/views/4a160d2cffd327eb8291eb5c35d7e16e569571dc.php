            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Delivery Person')); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <?php if(($item->id)): ?>
                        <?php echo Form::open(['route' => ['deliveryperson.update',$item->id], 'method' => 'put', 'files' => true]); ?>

                        <?php else: ?>
                        <?php echo Form::open(['route' => 'deliveryperson.store', 'method' => 'post', 'files' => true]); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mt-4">
                                    <a href="<?php echo e(route('deliveryperson.index')); ?>" class="btn btn-info"><i class="fa fa-undo px-2"></i> <?php echo e(trans('Back')); ?></a> 
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/deliveryperson/create_update.blade.php ENDPATH**/ ?>