             ...
             $challan_index_permission_active = DB::table('permissions')
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-cart"></i><span><?php echo e(trans('Service')); ?></span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  <li id="ledger-list-menu"><a href="<?php echo e(route('ledgerinfo.index')); ?>"><?php echo e(trans('Ledger')); ?></a></li>
                  <?php endif; ?> 
              </ul>
              </li>
              <?php endif; ?>
...
</html><?php /**PATH /home/acquqkkb/public_html/dawlatbd/resources/views/layout/main.blade.php ENDPATH**/ ?>