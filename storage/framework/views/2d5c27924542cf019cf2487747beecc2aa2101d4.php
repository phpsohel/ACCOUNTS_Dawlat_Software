...
<section>
	...
	<div class="col-md-6 offset-md-3 mt-4">
        <div class="form-group row">
            ...
            <hr>
            <div class="input-group-append">
                <a type="button" class="btn btn-primary" href="<?php echo e(route('export-pdf', ['start_date' => $start_date, 'end_date' => $end_date])); ?>">PDF</a><br>     
            </div>

             <div class="input-group-append">
                 <a type="button" class="btn btn-primary" href="<?php echo e(route('summary-print', ['start_date' => $start_date, 'end_date' => $end_date])); ?>">Print</a>
            </div>
			...
			<div class="col-md-4">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2"><?php echo e(trans('file.profit')); ?> <span class="float-right"> <?php echo e(number_format((float)$purchase[0]->grand_total, 2, '.', '')); ?></span></p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/hisab/resources/views/report/profit_loss.blade.php ENDPATH**/ ?>