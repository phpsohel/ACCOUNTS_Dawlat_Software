...
<?php echo Form::open(['route' => 'voucherinfo.store', 'method' => 'post', 'files' => true]); ?>

<div class="row">
    <div class="col-md-12">
        <strong class="upper_case"><?php echo e(($bill->customer->name  ?? '').'( '.($bill->customer->customer_code ?? '').' )'); ?></strong>
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="voucher_no" value="<?php echo e($auto_voucher ?? ''); ?>"  readonly>
                    <input type="hidden" class="form-control" name="bill_id" value="<?php echo e($bill->id ?? ''); ?>" >
                   
                    <input type="hidden" class="form-control" name="vendor_id"  value="<?php echo e($bill->vendor_id ?? 0); ?>">
                ...
                <div class="form-group branch_name" style="display: none">
                    ...
                    <input type="text" class="form-control" name="branch_name" value="<?php echo e(old('branch_name')); ?>">
                </div>
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="form-group">
                     <h3 class="text-info">Due Amount   ( <?php echo e(($bill->payable_amount ?? 0) - ($bill->paid_amount?? 0)); ?> )</h3>
                </div>
                <div class="form-group">
                    <h3 class="text-primary">Payment Date</h3>
                   <div class="">
                       <input type="date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" name="payment_date" required>
                   </div>
...
</script><?php /**PATH /home/acquqkkb/public_html/dawlatbd/resources/views/voucherinfo/get_bill_by_ajax.blade.php ENDPATH**/ ?>