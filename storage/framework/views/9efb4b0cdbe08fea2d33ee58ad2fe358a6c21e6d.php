<?php $__env->startSection('home_content'); ?>
     <style>
        ...
        <main class="main">
            <div class="home-slider-container">
                <div class="home-slider owl-carousel owl-theme owl-theme-light">
                    <div class="home-slide">
                        <div class="slide-bg owl-lazy"  data-src="<?php echo e(asset('/')); ?>public/assets/frontend/images/slider/slide-1.jpg"></div><!-- End .slide-bg -->
                        <div class="container">
                            <div class="home-slide-content">
                                <div class="slide-border-top">
                                    <!-- <img src="<?php echo e(asset('/')); ?>public/assets/frontend/images/slider/border-top.png" alt="Border" width="290" height="38"> -->
                                ...
                                <div class="slide-border-bottom">
                                    <!-- <img src="<?php echo e(asset('/')); ?>public/assets/frontend/images/slider/border-bottom.png" alt="Border" width="290" height="111"> -->
                    ...
                    <div class="home-slide">
                        <div class="slide-bg owl-lazy"  data-src="<?php echo e(asset('/')); ?>public/assets/frontend/images/slider/slide-2.jpg"></div><!-- End .slide-bg -->
                        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="banner banner-image">
                                <a href="#">
                                    <img src="<?php echo e(asset('/')); ?>public/assets/frontend/images/banners/banner-1.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->
                        </div><!-- End .col-md-4 -->
                        ...
                        <div class="col-md-4">
                            <div class="banner banner-image">
                                <a href="#">
                                    <img src="<?php echo e(asset('/')); ?>public/assets/frontend/images/banners/banner-2.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->
                        </div><!-- End .col-md-4 -->
                        ...
                        <div class="col-md-4">
                            <div class="banner banner-image">
                                <a href="#">
                                    <img src="<?php echo e(asset('/')); ?>public/assets/frontend/images/banners/banner-3.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->
                        </div><!-- End .col-md-4 -->
                    </div><!-- End .row -->
            ...
            <div class="promo-section" style="background-blend-mode: overlay; background-image: url(<?php echo e(asset('/')); ?>public/assets/frontend/images/promo-bg.jpg)">
                <div class="container">
            ...
            <div class="partners-container">
                <div class="container">
                    <div class="partners-carousel owl-carousel owl-theme">
                        ...
                        <a href="<?php echo e(route('brands-product', $row->id)); ?>" class="partner">
                            <img src="<?php echo e(url('public/images/brand', $row->image)); ?>" alt="logo" style="width: auto; height: 70px;">
                        </a>
                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <article class="entry">
                            <div class="entry-media">
                                <a href="<?php echo e(route('blog-post', $row->id)); ?>">
                                    <img src="<?php echo e($row->blog_image); ?>" alt="Post">
                                </a>
                                <div class="entry-date"><?php echo e(date('d', strtotime($row->created_at))); ?><span><?php echo e(date('M', strtotime($row->created_at))); ?></span></div><!-- End .entry-date -->
                            </div><!-- End .entry-media -->
                            ...
                            <div class="entry-body">
                                ...
                                <div class="entry-content">
                                    ...
                                    <a href="<?php echo e(route('blog-post', $row->id)); ?>" class="btn btn-dark">Read More</a>
...
<?php echo $__env->make('layout.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salepropos\resources\views/eshop/home.blade.php ENDPATH**/ ?>