             ...
             $challan_index_permission_active = DB::table('permissions')
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-cart"></i><span><?php echo e(trans('Service')); ?></span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  <li id="challan-list-menu"><a href="<?php echo e(route('challaninfo.index')); ?>"><?php echo e(trans('General Challan')); ?></a></li>
                  <?php if(Auth()->user()->role_id == 1): ?>
                  <li id="approved-challan-list-menu"><a href="<?php echo e(route('approvedChallanList')); ?>"><?php echo e(trans('Approved Challan')); ?></a></li>
                  <?php endif; ?>
                  <li id="bill-list-menu"><a href="<?php echo e(route('billinfo.index')); ?>"><?php echo e(trans('Bill List')); ?></a></li>

                  <?php endif; ?>  
              <?php if($customer_index_permission_active): ?>
                  <li id="customer-list-menu"><a href="<?php echo e(route('customer.index')); ?>">Vendor List</a></li>
              <?php endif; ?>
              <?php if($billar_index_permission_active): ?>
                      <li id="user-list-menu"><a href="<?php echo e(route('biller.index')); ?>"><?php echo e(trans('Biller List')); ?></a></li>
                      <li id="delivery-list-menu"><a href="<?php echo e(route('deliveryperson.index')); ?>">Delivery Person</a></li>
                      <li id="sales-list-menu"><a href="<?php echo e(route('salesperson.index')); ?>">Sales Person</a></li>
              <?php endif; ?>
              </ul>
              </li>
              <?php endif; ?>
