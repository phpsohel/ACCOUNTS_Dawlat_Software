                    ...
                    <div class="card-body">
						...
						<div class="table-responsive">
						    <table class="table table-bordered permission-table">
						        ...
						        <tbody>
									<tr>
										<td><?php echo e(trans('file.Brand')); ?></td>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													<?php if(in_array("brand-add", $all_permission)): ?>
													   <input type="checkbox" value="1" id="brand-add" name="brand-add" checked>
													<?php else: ?>
													<input type="checkbox" value="1" id="brand-add" name="brand-add">
													<?php endif; ?>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													<?php if(in_array("brand-edit", $all_permission)): ?>
													<input type="checkbox" value="1" id="brand-edit" name="brand-edit" checked />
													<?php else: ?>
													<input type="checkbox" value="1" id="brand-edit" name="brand-edit" />
													<?php endif; ?>
													<label for="brand-edit"></label>
												</div>
											</div>
										</td>
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													<?php if(in_array("brand-delete", $all_permission)): ?>
													<input type="checkbox" value="1" id="brand-delete" name="brand-delete" checked />
													<?php else: ?>
													<input type="checkbox" value="1" id="brand-delete" name="brand-delete" />
													<?php endif; ?>
													<label for="brand-delete"></label>
												</div>
											</div>
										</td>
									</tr>
						                ...
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("category-add", $all_permission)): ?>
								               	<input type="checkbox" value="1" id="category-add" name="category-add" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="category-add" name="category-add">
								                <?php endif; ?>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="category-edit" name="category-edit" checked />
								                <?php else: ?>
								                <input type="checkbox" value="1" id="category-edit" name="category-edit" />
								                <?php endif; ?>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="category-delete" name="category-delete" checked />
								                <?php else: ?>
								                <input type="checkbox" value="1" id="category-delete" name="category-delete" />
								                <?php endif; ?>
								...
								<tr>
						            <td><?php echo e(trans('Challan')); ?></td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("challan-index", $all_permission)): ?>
								                <input type="checkbox" value="1" id="challan-index" name="challan-index" checked />
								                <?php else: ?>
								                <input type="checkbox" value="1" id="challan-index" name="challan-index">
								                <?php endif; ?>
								                <label for="challan-index"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("challan-add", $all_permission)): ?>
								                <input type="checkbox" value="1" id="challan-add" name="challan-add" checked />
								                <?php else: ?>
								                <input type="checkbox" value="1" id="challan-add" name="challan-add">
								                <?php endif; ?>
								                <label for="challan-add"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("challan-edit", $all_permission)): ?>
								                <input type="checkbox" value="1" id="challan-edit" name="challan-edit" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="challan-edit" name="challan-edit">
								                <?php endif; ?>
								                <label for="challan-edit"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("challan-deleted", $all_permission)): ?>
								                <input type="checkbox" value="1" id="challan-deleted" name="challan-deleted" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="challan-deleted" name="challan-deleted">
								                <?php endif; ?>
								                <label for="challan-deleted"></label>
								            </div>
						            	</div>
						            </td>
						        </tr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/role/permission.blade.php ENDPATH**/ ?>