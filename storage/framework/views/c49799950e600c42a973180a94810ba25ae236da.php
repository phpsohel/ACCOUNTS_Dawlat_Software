...
<section class="forms">
    <div class="container-fluid">
        <h3><?php echo e(trans('file.Balance Sheet')); ?></h3>
    </div>
        ...
        <table id="account-table" class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e(number_format((float)$credit[$key], 2, '.', '')); ?></td>
                    <td><?php echo e(number_format((float)($debit[$key] * -1), 2, '.', '')); ?></td>
                    <td><?php echo e(number_format((float)($credit[$key] - $debit[$key]), 2, '.', '')); ?></td>
                </tr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/hisab/resources/views/account/balance_sheet.blade.php ENDPATH**/ ?>