...
<section>
    <div class="container-fluid">
        <?php if(in_array("purchase-return-add", $all_permission)): ?>
            <a href="<?php echo e(route('return-purchase.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add Return')); ?></a>
        <?php endif; ?>
    </div>
    <div class="table-responsive">
        <table id="return-table" class="table return-list">
            ...
            <tbody>
                ...
                ?>
                <tr class="return-link" data-return='["<?php echo e(date($general_setting->date_format, strtotime($return->created_at->toDateString()))); ?>", "<?php echo e($return->reference_no); ?>", "<?php echo e($return->warehouse->name); ?>", "<?php echo e($return->warehouse->phone); ?>", "<?php echo e($return->warehouse->address); ?>", "<?php echo e($supplier->name); ?>", "<?php echo e($supplier->company_name); ?>","<?php echo e($supplier->email); ?>", "<?php echo e($supplier->phone_number); ?>", "<?php echo e($supplier->address); ?>", "<?php echo e($supplier->city); ?>", "<?php echo e($return->id); ?>", "<?php echo e($return->total_tax); ?>", "<?php echo e($return->total_discount); ?>", "<?php echo e($return->total_cost); ?>", "<?php echo e($return->order_tax); ?>", "<?php echo e($return->order_tax_rate); ?>", "<?php echo e($return->grand_total); ?>", "<?php echo e($return->return_note); ?>", "<?php echo e($return->staff_note); ?>", "<?php echo e($return->user->name); ?>", "<?php echo e($return->user->email); ?>"]'>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a href="<?php echo e(route('return-purchase.edit', $return->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
          ...
          <div class="modal-content">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <?php echo e(Form::open(['route' => 'return-purchase.sendmail', 'method' => 'post', 'class' => 'sendmail-form'] )); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/hisab/resources/views/return_purchase/index.blade.php ENDPATH**/ ?>