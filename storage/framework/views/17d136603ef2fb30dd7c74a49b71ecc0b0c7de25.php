        ...
        <table id="biller-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('Website Link')); ?></th>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($biller->id); ?>">
                    ...
                    <td><?php echo e($biller->website_link ?? ''); ?></td>
                    <td><?php echo e($biller->designation ?? ''); ?></td>
                    <td><?php echo e($biller->email ?? ''); ?></td>
                    <td><?php echo e($biller->phone_number ?? ''); ?></td>
                    <td><?php echo e($biller->address ?? ''); ?></td>
                    <td>
                        <div class="btn-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dawlatbd\resources\views/biller/index.blade.php ENDPATH**/ ?>