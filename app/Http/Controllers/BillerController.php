...
class BillerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($image) {
            ...
            $imageName = rand(9999,333).$imageName . '.' . $ext;
    ...
    public function update(Request $request, $id)
    {
        ...
        $imageName = '';
        if(!empty($request->except('image')))
        {
           
                    if(!empty($lims_biller_data->image))
                    {
                        $picture = "public/images/biller/{$lims_biller_data->image}";
                        //  return $picture;
            ...
            $imageName = $lims_biller_data->image;
        }
