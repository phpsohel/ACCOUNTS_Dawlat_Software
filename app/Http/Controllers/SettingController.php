...
class SettingController extends Controller
{
    ...
    public function report_setting()
    {
        ...
        // echo "string1111111"; exit();
        // return $lims_general_setting_data->site_logo; exit();
        $lims_account_list = Account::where('is_active', true)->get();
        $lims_currency_list = Currency::get();
        $zones_array = array();
        $timestamp = time();
        ...
        return view('setting.report_setting', compact('lims_general_setting_data', 'lims_account_list', 'zones_array', 'lims_currency_list'));
    }
    ...
    public function generalSettingStore(Request $request)
    {
        ...
        $general_setting->phone = $data['phone'];
        $general_setting->email = $data['email'];
        $general_setting->website_link = $data['website_link'];
