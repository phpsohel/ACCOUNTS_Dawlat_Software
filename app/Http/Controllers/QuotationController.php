...
class QuotationController extends Controller
{
    ...
    public function challanwithquationshow(Request $request)
    {
        $data['items'] = $items = ProductQuotation::where('quotation_id',$request->id)->get();
      
        return view('quotation.modal_challan_details',$data);
    }
    ...
    public function store(Request $request)
    {
      ...
      // return $request->all();
        ...
        // $data['shipping_item'] = $data['shipping_item'];
      ...
      //  $tax = $data['tax'];
        ...
        return redirect()->route('productQuotationChallanpfd',$lims_quotation_data->id)->with('message', $message);
    }
