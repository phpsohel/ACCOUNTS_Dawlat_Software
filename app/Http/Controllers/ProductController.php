...
class ProductController extends Controller
{
    ...
    public function productData(Request $request)
    {
        ...
        if(!empty($products))
        {
            foreach ($products as $key=>$product)
            {
                ...
                $nestedData['product_dimension'] = $product->product_dimension;
                ...
                $nestedData['product'] = array( '[ "'.$product->type.'"', ' "'.$product->name.'"', ' "'.$product->code.'"', ' "'.$nestedData['brand'].'"', ' "'.$nestedData['category'].'"', ' "'.$nestedData['unit'].'"', ' "'.$product->cost.'"', ' "'.$product->price.'"', ' "'.$tax.'"', ' "'.$tax_method.'"', ' "'.$product->product_dimension.'"', ' "'.preg_replace('/\s+/S', " ", $product->product_details).'"', ' "'.$product->id.'"', ' "'.$product->product_list.'"', ' "'.$product->qty_list.'"', ' "'.$product->price_list.'"', ' "'.$product->qty.'"', ' "'.$product->image.'"]'
                );
    ...
    public function store(Request $request)
    {
       // return $request->all();
        ...
        $data['name'] = ($data['name']);
        $data['qty'] = ($data['qty']);
        $data['product_dimension'] = ($data['product_dimension']);
        if($data['type'] == 'combo'){
